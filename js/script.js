...
for (var i = 0; i < 100; i++) {
  if (!(listaNumeri[i+1]%3) && listaNumeri[i+1]%5) listaNumeri[i+1] = "Fizz";
  else if (!(listaNumeri[i+1]%5) && listaNumeri[i+1]%3) listaNumeri[i+1] = "Buzz";
  else if (!(listaNumeri[i+1]%3) && !(listaNumeri[i+1]%5)) listaNumeri[i+1] = "FizzBuzz";
}
